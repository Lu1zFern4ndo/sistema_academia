...
class PagamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pagamento" do
    assert_difference("Pagamento.count") do
      post pagamentos_url, params: { pagamento: { aluno_id: @pagamento.aluno_id, atividade_fisica_id: @pagamento.atividade_fisica_id, data_pagamento: @pagamento.data_pagamento, valor_pago: @pagamento.valor_pago } }
    end
  ...
  test "should update pagamento" do
    patch pagamento_url(@pagamento), params: { pagamento: { aluno_id: @pagamento.aluno_id, atividade_fisica_id: @pagamento.atividade_fisica_id, data_pagamento: @pagamento.data_pagamento, valor_pago: @pagamento.valor_pago } }
